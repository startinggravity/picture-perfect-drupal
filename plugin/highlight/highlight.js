...
hljs.LANGUAGES.brainfuck = function (a) {
    return {
        c: [{
            ...
            e: "[\\[\\]\\.,\\+\\-<> \r\n]",
            r: 0
        }, {cN: "title", b: "[\\[\\]]", r: 0}, {cN: "string", b: "[\\.,]"}, {cN: "literal", b: "[\\+\\-]"}]
    }
}(hljs);
...
hljs.LANGUAGES.erlang = function (i) {
    ...
    var b = {
        ...
        r: 0,
        rB: true,
        c: [{cN: "record_name", b: "#" + i.UIR, r: 0}, {b: "{", eW: true, r: 0}]
    };
...
hljs.LANGUAGES.fsharp = function (a) {
    ...
    return {
        ...
        c: [{cN: "string", b: '@"', e: '"', c: [{b: '""'}]}, {cN: "string", b: '"""', e: '"""'}, {
            ...
            e: ">",
            c: [{cN: "title", b: b}]
        }, a.CLCM, a.CBLCLM, a.inherit(a.ASM, {i: null}), a.inherit(a.QSM, {i: null}), a.CNM]
    }
}(hljs);
...
hljs.LANGUAGES.haskell = function (a) {
    ...
    var c = {
        ...
        e: "\\)",
        i: '"',
        c: [{cN: "type", b: "\\b[A-Z][\\w]*(\\((\\.\\.|,|\\w+)\\))?"}, {cN: "title", b: "[_a-z][\\w']*"}]
    };
    ...
    return {
        ...
        c: [{cN: "comment", b: "--", e: "$"}, {cN: "preprocessor", b: "{-#", e: "#-}"}, {
            cN: "comment",
            c: ["self"],
            b: "{-",
            e: "-}"
            ...
            c: [d, c, b]
        }, a.CNM, {cN: "shebang", b: "#!\\/usr\\/bin\\/env runhaskell", e: "$"}, d, {
            cN: "title",
            b: "^[_a-z][\\w']*"
        }, {b: "->|<-"}]
    }
...
hljs.LANGUAGES.lasso = function (b) {
    ...
    return {
        ...
        c: [{
            ...
            b: "\\[",
            r: 0
        }, {cN: "shebang", b: "^#!.+lasso9\\b", r: 10}, b.CLCM, {
            cN: "javadoc",
            b: "/\\*\\*!",
            e: "\\*/"
        }, b.CBLCLM, b.CNM, b.inherit(b.ASM, {i: null}), b.inherit(b.QSM, {i: null}), {
            cN: "string",
            b: "`",
            e: "`"
        }, {cN: "variable", b: "#\\d+|[#$]" + a}, {cN: "tag", b: "::", e: a}, {
            cN: "attribute",
            b: "\\.\\.\\.|-" + b.UIR
        }, {cN: "class", bWK: true, k: "define", eE: true, e: "\\(|=>", c: [{cN: "title", b: b.UIR + "=?"}]}]
    }
}(hljs);
hljs.LANGUAGES.lisp = function (i) {
    ...
    var d = [{cN: "number", b: m}, {cN: "number", b: "#b[0-1]+(/[0-1]+)?"}, {
        cN: "number",
        b: "#o[0-7]+(/[0-7]+)?"
